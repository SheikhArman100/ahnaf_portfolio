  ...
  return (
    <>
      <div className="fixed z-20 flex h-[4rem] w-full items-center justify-between border-b-[1rem] border-t-[1rem]  border-b-[#006a4e]	border-t-[#f42a41] bg-bgColor px-10 transition-[all_0.5s_ease] md:relative md:justify-end md:px-4">
        ...
        <button
          type="button"
          className="mr-6 flex-[0_1_auto] rounded-full border border-[#006a4e] bg-[#006a4e] py-2 px-4 text-base font-bold text-bgColor shadow-xl transition-[all_0.5s_ease] hover:border-[#006a4e] hover:bg-bgColor hover:text-accentColor md:hidden"
        >
      ...
      {active ? (
        ...
        >
          ...
          <button
            type="button"
            className=" rounded-full border-2  bg-[#006a4e] py-2 px-4 text-base font-bold text-bgColor transition-[all_0.5s_ease] hover:border-[#006a4e] hover:bg-bgColor hover:text-accentColor "
          >
            <Link to="contact" smooth duration={500}>
              Contact Me
            </Link>
