...
function Contact() {
  return (
    ...
    >
      ...
      <div className="flex  items-center justify-center gap-x-20 sm:gap-x-1 md:gap-x-3 ">
        <div className="flex aspect-square w-40 flex-[1_1_auto] flex-col items-center rounded-lg  py-6 px-2 text-center text-bgColor sm:px-1 sm:py-3">
          <IoLocationSharp size={40} />
          <span className="font-bold md:text-sm">Location</span>
          <p className="mt-2 font-secondText text-xs ">
            House #22, Road #23, Block #B, Banani, Dhaka-1213
          </p>
        </div>
        <div className="flex aspect-square w-40 flex-[1_1_auto] flex-col items-center rounded-lg  py-6 px-2 text-center text-bgColor">
          <CgPhone size={40} />
          <span className="font-bold md:text-sm">Phone</span>
          <p className=" mt-2 font-secondText text-xs ">0189 482 9666</p>
          <p className="font-secondText text-xs ">0176 865 4422</p>
        </div>
        <div className="flex aspect-square w-40 flex-[1_1_auto] flex-col items-center rounded-lg  py-6 px-2 text-center text-bgColor">
          <MdEmail size={40} />
          <span className="font-bold md:text-sm">Email Address</span>
